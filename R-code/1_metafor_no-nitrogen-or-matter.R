...
###  remove nitrogen-, phosphorus-, and matter-based data
dat0 <- dat0[which(dat0$rv %in% c("POC", "TOC", "MAOC", "SOC")& is.na(dat0$logRR)==FALSE & is.na(dat0$var)==FALSE),]
unique(dat0$StudyID) # carbon-based effect sizes
...
write.csv(respvars, "Processed-data/1_response variables across studies_no-nitrogen-or-matter.csv")
...
write.csv(StudyIDs, "Processed-data/0_StudyIDs_no-nitrogen-or-matter.csv")
...
write.csv(dat_POC, "Processed-data/POC_no-nitrogen-or-matter.csv")
write.csv(dat_MAOC, "Processed-data/MAOC_no-nitrogen-or-matter.csv")
write.csv(dat_SOC, "Processed-data/SOC_no-nitrogen-or-matter.csv")
...
# write files
sink(file = "Model-output/1_Overall/POC_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
sink(file = "Model-output/2_Significance-of-variation/POC_within-study_no-nitrogen-or-matter.txt"); anova(mod, mod_2); sink(file = NULL) # if p<0.05, within-study variance is significant
sink(file = "Model-output/2_Significance-of-variation/POC_between-study_no-nitrogen-or-matter.txt"); anova(mod, mod_3); sink(file = NULL) # if p<0.05, between-study variance is significant
sink(file = "Model-output/3_Partitioning-of-variation/POC_no-nitrogen-or-matter.txt"); data.frame(samplingvar = I2_1 * 100, withinstudyvar = I2_2 * 100, betweenstudyvar = I2_3 * 100); sink(file = NULL)
...
I2_3 <- (mod$sigma2[2]) / (mod$sigma2[1]  + mod$sigma2[2] + estimated.sampling.variance)
# write files
sink(file = "Model-output/1_Overall/MAOC_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
sink(file = "Model-output/2_Significance-of-variation/MAOC_within-study_no-nitrogen-or-matter.txt"); anova(mod, mod_2); sink(file = NULL) # if p<0.05, within-study variance is significant
sink(file = "Model-output/2_Significance-of-variation/MAOC_between-study_no-nitrogen-or-matter.txt"); anova(mod, mod_3); sink(file = NULL) # if p<0.05, between-study variance is significant
sink(file = "Model-output/3_Partitioning-of-variation/MAOC_no-nitrogen-or-matter.txt"); data.frame(samplingvar = I2_1 * 100, withinstudyvar = I2_2 * 100, betweenstudyvar = I2_3 * 100); sink(file = NULL)
...
I2_3 <- (mod$sigma2[2]) / (mod$sigma2[1]  + mod$sigma2[2] + estimated.sampling.variance)
# write files
sink(file = "Model-output/1_Overall/SOC_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
sink(file = "Model-output/2_Significance-of-variation/SOC_within-study_no-nitrogen-or-matter.txt"); anova(mod, mod_2); sink(file = NULL) # if p<0.05, within-study variance is significant
sink(file = "Model-output/2_Significance-of-variation/SOC_between-study_no-nitrogen-or-matter.txt"); anova(mod, mod_3); sink(file = NULL) # if p<0.05, between-study variance is significant
sink(file = "Model-output/3_Partitioning-of-variation/SOC_no-nitrogen-or-matter.txt"); data.frame(samplingvar = I2_1 * 100, withinstudyvar = I2_2 * 100, betweenstudyvar = I2_3 * 100); sink(file = NULL)
...
sink(file = "Model-output/4_Single-moderator/POC_depth.type_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+ccseason.winter +  ccseason.spring + ccseason.summer + ccseason.yearround, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat, )
sink(file = "Model-output/4_Single-moderator/POC_ccseason_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+ccadded.grass + ccadded.legume + ccadded.grasslegume + ccadded.brassica + ccadded.grasslegumebrassica, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/POC_ccadded_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+maincrop.cereal + maincrop.legume + maincrop.cereallegume + maincrop.otherrowcrop + maincrop.perennial, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/POC_maincrop_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+tillage.conventional + tillage.reducednotill, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/POC_tillage_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
sink(file = "Model-output/4_Single-moderator/POC_nfert_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
sink(file = "Model-output/4_Single-moderator/POC_ag.C.inputs_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
sink(file = "Model-output/4_Single-moderator/POC_species.added_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
sink(file = "Model-output/4_Single-moderator/POC_duration_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
sink(file = "Model-output/4_Single-moderator/POC_sand_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
sink(file = "Model-output/4_Single-moderator/POC_silt_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
sink(file = "Model-output/4_Single-moderator/POC_clay_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
sink(file = "Model-output/4_Single-moderator/POC_toc_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
sink(file = "Model-output/4_Single-moderator/POC_ph_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
sink(file = "Model-output/4_Single-moderator/POC_Temp_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
sink(file = "Model-output/4_Single-moderator/POC_Prec_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+soilorder.Alfisols + soilorder.Oxisols + soilorder.Mollisols + soilorder.Ultisols + soilorder.Inceptisols, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/POC_soilorder_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
sink(file = "Model-output/4_Single-moderator/POC_Continent_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+SoilCollectionSeason.winter + SoilCollectionSeason.spring + SoilCollectionSeason.summer + SoilCollectionSeason.fall, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/POC_SoilCollectionSeason_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+FractionationMethod.Size + FractionationMethod.Density , 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/POC_FractionationMethod_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+DispersingAgent.SodiumHex + DispersingAgent.OtherSolution + DispersingAgent.GlassBeads + DispersingAgent.Sonication + DispersingAgent.Combo, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/POC_DispersingAgent_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+ResponseCalc.Direct + ResponseCalc.Indirect, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/POC_ResponseCalc_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
write.csv(effectsdat_POC, "Model-output/4_Single-moderator/effects-by-category_POC_no-nitrogen-or-matter.csv")
write.csv(stats_POC, "Model-output/4_Single-moderator/stats-by-category_POC_no-nitrogen-or-matter.csv")
...
mod <- rma.mv(logRR, var, mods= ~0+depth.surface + depth.subsoil , 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/MAOC_depth.type_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+ccseason.winter + ccseason.summer + ccseason.yearround, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat, )
sink(file = "Model-output/4_Single-moderator/MAOC_ccseason_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+ccadded.grass + ccadded.legume + ccadded.grasslegume, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/MAOC_ccadded_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+maincrop.cereal + maincrop.legume + maincrop.cereallegume + maincrop.perennial, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/MAOC_maincrop_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+tillage.conventional + tillage.reducednotill, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/MAOC_tillage_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
## nfert
mod <- rma.mv(logRR, var, mods= ~nfert, random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/MAOC_nfert_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
## ag.C.inputs
mod <- rma.mv(logRR, var, mods= ~ag.C.inputs, random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/MAOC_ag.C.inputs_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
## species.added
mod <- rma.mv(logRR, var, mods= ~species.added, random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/MAOC_species.added_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
## duration
mod <- rma.mv(logRR, var, mods= ~duration, random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/MAOC_duration_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
## sand
mod <- rma.mv(logRR, var, mods= ~sand, random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/MAOC_sand_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
## silt
mod <- rma.mv(logRR, var, mods= ~silt, random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/MAOC_silt_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
## clay
mod <- rma.mv(logRR, var, mods= ~clay, random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/MAOC_clay_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
## toc 
mod <- rma.mv(logRR, var, mods= ~toc, random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/MAOC_toc_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
## ph
mod <- rma.mv(logRR, var, mods= ~ph, random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/MAOC_ph_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
## Temp
mod <- rma.mv(logRR, var, mods= ~Temp, random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/MAOC_Temp_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
## Prec
mod <- rma.mv(logRR, var, mods= ~Prec, random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/MAOC_Prec_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+soilorder.Alfisols + soilorder.Oxisols + soilorder.Mollisols + soilorder.Ultisols, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/MAOC_soilorder_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
sink(file = "Model-output/4_Single-moderator/MAOC_Continent_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+ SoilCollectionSeason.spring + SoilCollectionSeason.summer + SoilCollectionSeason.fall, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/MAOC_SoilCollectionSeason_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+FractionationMethod.Size + FractionationMethod.Density, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/MAOC_FractionationMethod_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+DispersingAgent.SodiumHex + DispersingAgent.OtherSolution + DispersingAgent.GlassBeads + DispersingAgent.Combo, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/MAOC_DispersingAgent_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+ResponseCalc.Direct + ResponseCalc.Indirect, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/MAOC_ResponseCalc_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
write.csv(effectsdat_MAOC, "Model-output/4_Single-moderator/effects-by-category_MAOC_no-nitrogen-or-matter.csv")
write.csv(stats_MAOC, "Model-output/4_Single-moderator/stats-by-category_MAOC_no-nitrogen-or-matter.csv")
...
mod <- rma.mv(logRR, var, mods= ~0+depth.surface + depth.subsoil  + depth.deepsoil , 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/SOC_depth.type_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+ccseason.winter +  ccseason.spring + ccseason.summer + ccseason.yearround, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat, )
sink(file = "Model-output/4_Single-moderator/SOC_ccseason_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+ccadded.grass + ccadded.legume + ccadded.grasslegume + ccadded.brassica + ccadded.grasslegumebrassica, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/SOC_ccadded_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+maincrop.cereal + maincrop.legume + maincrop.cereallegume + maincrop.otherrowcrop + maincrop.perennial, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/SOC_maincrop_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+tillage.conventional + tillage.reducednotill, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/SOC_tillage_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
## nfert
mod <- rma.mv(logRR, var, mods= ~nfert, random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/SOC_nfert_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
## ag.C.inputs
mod <- rma.mv(logRR, var, mods= ~ag.C.inputs, random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/SOC_ag.C.inputs_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
## species.added
mod <- rma.mv(logRR, var, mods= ~species.added, random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/SOC_species.added_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
## duration
mod <- rma.mv(logRR, var, mods= ~duration, random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/SOC_duration_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
## sand
mod <- rma.mv(logRR, var, mods= ~sand, random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/SOC_sand_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
## silt
mod <- rma.mv(logRR, var, mods= ~silt, random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/SOC_silt_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
## clay
mod <- rma.mv(logRR, var, mods= ~clay, random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/SOC_clay_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
## toc 
mod <- rma.mv(logRR, var, mods= ~toc, random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/SOC_toc_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
## ph
mod <- rma.mv(logRR, var, mods= ~ph, random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/SOC_ph_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
## Temp
mod <- rma.mv(logRR, var, mods= ~Temp, random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/SOC_Temp_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
## Prec
mod <- rma.mv(logRR, var, mods= ~Prec, random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/SOC_Prec_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+soilorder.Alfisols + soilorder.Oxisols + soilorder.Mollisols + soilorder.Ultisols + soilorder.Inceptisols, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/SOC_soilorder_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
## Continent, 6 levels: Continent.Africa + Continent.Asia + Continent.Australia + Continent.Europe + Continent.NorthAmerica + Continent.SouthAmerica
mod <- rma.mv(logRR, var, mods= ~0+Continent.Europe + Continent.NorthAmerica + Continent.SouthAmerica, random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/SOC_Continent_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+ SoilCollectionSeason.spring + SoilCollectionSeason.summer + SoilCollectionSeason.fall, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/SOC_SoilCollectionSeason_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+FractionationMethod.Size + FractionationMethod.Density, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/SOC_FractionationMethod_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+DispersingAgent.SodiumHex + DispersingAgent.OtherSolution + DispersingAgent.GlassBeads + DispersingAgent.Sonication, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/SOC_DispersingAgent_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
mod <- rma.mv(logRR, var, mods= ~0+ResponseCalc.Direct, 
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/4_Single-moderator/SOC_ResponseCalc_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
write.csv(effectsdat_SOC, "Model-output/4_Single-moderator/effects-by-category_SOC_no-nitrogen-or-matter.csv")
write.csv(stats_SOC, "Model-output/4_Single-moderator/stats-by-category_SOC_no-nitrogen-or-matter.csv")
...
mod <- rma.mv(logRR, var, mods= ~ 0 + 
              ...
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/5_Full-models/1_POC-full_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
write.csv(anova_table, "Model-output/5_Full-models/2_POC-anova-by-mod_no-nitrogen-or-matter.csv")
...
mod2 <- rma.mv(logRR, var, mods= ~ 0 + 
                 ...
                 ag.C.inputs,
               random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/5_Full-models/1_MAOC-full_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod2
...
write.csv(anova_table, "Model-output/5_Full-models/2_MAOC-anova-by-mod_no-nitrogen-or-matter.csv")
...
mod <- rma.mv(logRR, var, mods= ~ 0 + 
                ...
                ag.C.inputs ,
              random = list(~ 1 | Obs.ID, ~ 1 | StudyNum), tdist=TRUE, data=dat)
sink(file = "Model-output/5_Full-models/1_SOC-full_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
mod
...
write.csv(anova_table, "Model-output/5_Full-models/2_SOC-anova-by-mod_no-nitrogen-or-matter.csv")
...
I2_3 <- (mod$sigma2[2]) / (mod$sigma2[1]  + mod$sigma2[2] + estimated.sampling.variance)
# write files
sink(file = "Model-output/1_Overall/POC_final_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
sink(file = "Model-output/2_Significance-of-variation/POC_within-study_final_no-nitrogen-or-matter.txt"); anova(mod, mod_2); sink(file = NULL) # if p<0.05, within-study variance is significant
sink(file = "Model-output/2_Significance-of-variation/POC_between-study_final_no-nitrogen-or-matter.txt"); anova(mod, mod_3); sink(file = NULL) # if p<0.05, between-study variance is significant
sink(file = "Model-output/3_Partitioning-of-variation/POC_final_no-nitrogen-or-matter.txt"); data.frame(samplingvar = I2_1 * 100, withinstudyvar = I2_2 * 100, betweenstudyvar = I2_3 * 100); sink(file = NULL)
...
I2_3 <- (mod$sigma2[2]) / (mod$sigma2[1]  + mod$sigma2[2] + estimated.sampling.variance)
# write files
sink(file = "Model-output/1_Overall/MAOC_final_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
sink(file = "Model-output/2_Significance-of-variation/MAOC_within-study_final_no-nitrogen-or-matter.txt"); anova(mod, mod_2); sink(file = NULL) # if p<0.05, within-study variance is significant
sink(file = "Model-output/2_Significance-of-variation/MAOC_between-study_final_no-nitrogen-or-matter.txt"); anova(mod, mod_3); sink(file = NULL) # if p<0.05, between-study variance is significant
sink(file = "Model-output/3_Partitioning-of-variation/MAOC_final_no-nitrogen-or-matter.txt"); data.frame(samplingvar = I2_1 * 100, withinstudyvar = I2_2 * 100, betweenstudyvar = I2_3 * 100); sink(file = NULL)
...
I2_3 <- (mod$sigma2[2]) / (mod$sigma2[1]  + mod$sigma2[2] + estimated.sampling.variance)
# write files
sink(file = "Model-output/1_Overall/SOC_final_no-nitrogen-or-matter.txt"); summary(mod); sink(file = NULL)
sink(file = "Model-output/2_Significance-of-variation/SOC_within-study_final_no-nitrogen-or-matter.txt"); anova(mod, mod_2); sink(file = NULL) # if p<0.05, within-study variance is significant
sink(file = "Model-output/2_Significance-of-variation/SOC_between-study_final_no-nitrogen-or-matter.txt"); anova(mod, mod_3); sink(file = NULL) # if p<0.05, between-study variance is significant
sink(file = "Model-output/3_Partitioning-of-variation/SOC_final_no-nitrogen-or-matter.txt"); data.frame(samplingvar = I2_1 * 100, withinstudyvar = I2_2 * 100, betweenstudyvar = I2_3 * 100); sink(file = NULL)
